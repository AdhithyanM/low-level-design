...
// Multiple Flights between one airport to another - bidirectional
public class FlightSystem2 {
    Map<String, Map<String, List<String>>> network;

    public FlightSystem2() {
    ...
    public static void main(String[] args) {
        FlightSystem2 flightSystem = new FlightSystem2();
